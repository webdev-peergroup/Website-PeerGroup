    ...
    <div class="l-main">
        <section class="artikel section">
            <div class="container__artikel">
                <!--Title Section-->
                <div class="title">
                    <h1 class="judul-konten"><span id ="artikel" class="kategori-artikel">Artikel</span> <span style="color: #EAA900">Kegiatan</span></h1>
                </div>
                <!--Content Section-->
                <div class="konten">
                    <!--Area artikel-->
                    <div class="artikel">
                        <?php foreach ($event->getResultArray() as $data) : ?>
                            <div class="box">
                                ...
                                <div class="text-list">
                                    <a href="/home/detevent/<?php echo $data['slug']?>" class="title-thumbnail"><?php echo $data['judul']?></a>
                                    <div class="penulis">
                    ...
                    <div class="Rekomendasi">
                        <div class="rekomendasi-container">
                            ...
                            <div class="rekomen-fill">
                               ...
                               ?>
                                    <a href="/home/detevent/<?php echo $rekomendasi['slug']?>">
                                     <div class="random">
